...
const Footer = () => {
  ...
  return (
    <div className="mx-0 h-screen w-full flex flex-col-reverse  xl:flex-row mt-[70px] mb-[100px] xl:mb-5 xl:mt-[10vh] xl:justify-center xl:items-center p-0 3xl:mt-[4vh] xl:mx-12">
        <motion.div
          ...
          <motion.p
            ...
            Your story is unique your digital presence should be too. If youre ready to propel your vision beyond the stratosphere, our crew at Planet-Pixel is eager to chart the course. Contact us to begin our collaboration.
          </motion.p>
          <form
            ref={formRef}
            ...
            <div className="flex flex-row justify-between w-full m-0 p-0 gap-3">
              <label className="flex w-full">
                <input
                  ...
                  className=" py-1 px-6 w-full text-[14px] placeholder:text-white text-white rounded-[5px] bg-white/20 border-2 border-white outline-none font-normal"
                />
              </label>
              <label className="flex w-full ">
                <input
